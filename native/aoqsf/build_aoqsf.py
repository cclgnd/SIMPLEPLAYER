...
def main():
    ...
    for src in sources:
        ...
        cmd = [compiler, "-m32", "-O2", "-std=c++17" if not is_c else "-std=c99", "-DWIN32", "-fpermissive", "-fvisibility=default", "-fomit-frame-pointer", "-fno-exceptions", "-ffunction-sections", "-fdata-sections"]
