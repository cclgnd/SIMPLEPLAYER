...
static void frames_to_le(uint8_t *data, unsigned int frame_count) {
    for (unsigned int i = 0; i < frame_count; i++) {
        int32_t l = ((int32_t *)data)[0];
        int32_t r = ((int32_t *)data)[1];
        int16_t sl = (int16_t)(l >> 16);
        int16_t sr = (int16_t)(r >> 16);
        data[0] = (uint8_t)(sl);
        data[1] = (uint8_t)(sl >> 8);
        data[2] = (uint8_t)(sr);
        data[3] = (uint8_t)(sr >> 8);
